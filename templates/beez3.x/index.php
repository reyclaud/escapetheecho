...
$this->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/media.css', 'text/css', 'screen');
...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            jQuery(".screen-dimension").html(jQuery(window).width() + 'px X ' + jQuery(window).height() + 'px');
        });
    </script>
</head>
<body id="shadow">
    <?php /* <div class="screen-dimension"></div> */ ?>
    <?php if ($this->countModules('ete-home')) : ?>
        <div id="home-wrapper">
            ...
            <div class="home-body">
                <jdoc:include type="modules" name="home-content" />
        ...
        <div id="all">
            <div id="back">
                ...
                <div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
                    ...
                    <div id="<?php echo $showRightColumn ? 'wrapper' : 'wrapper2'; ?>" <?php
                    if (isset($showno)) {

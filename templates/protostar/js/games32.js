...
jQuery(document).ready(function () {
    ...
    jQuery(".match-wrap button").click(function () {
        debatingGame.match();
    });
...
//    }
    ...
    debatingGame = {
        ...
        ini: function () {
            ...
            jQuery(".flip-container:gt(23)").find(".back").css({left: 0, right: 'auto', top: 'auto', bottom: 0, marginBottom: '0'});

            jQuery(".flip-container:eq(31)").find(".back").css({left: 'auto', right: '-2px'});

jQuery(window).load(function () {
    ...
    if (jQuery(".flip-container").length > 4) {
        ...
        jQuery(".flip-container-wrap").css({
            width: Math.ceil((1020 / 783) * 712) + "px"
        });
    }
            ...
            if (debatingGame.countFlipped() > 1) {
                ...
                if ((jQuery("div.flipped.front:eq(0)").parent().attr("data-bind") == jQuery("div.flipped.front:eq(1)").parent().attr("data-bind"))) {
                    ...
                    jQuery("div.flipped").parent().parent().fadeOut(300).fadeIn(300, function () {
                        ...
                        jQuery(ths).css({backgroundImage: 'url(./templates/protostar/images/funny-doctor.jpg)', backgroundSize: bgsize + " auto", backgroundPosition: position, backgroundRepeat: "no-repeat"});

                        if (jQuery(".paired_cards").length >= jQuery(".flip-container").length) {
                            jQuery(".flip-container-wrap").css({backgroundImage: 'url(./templates/protostar/images/funny-doctor.jpg)'});
...
//                        }
        ...
        zoomin: function (ths) {
            ...
            console.log(debatingGame.cardOriginalWidth);

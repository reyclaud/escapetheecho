...
class DebatingGameViewThirtytwocard extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        $doc->addStyleSheet('templates/' . $getTemplateName . '/css/games32.css');
        
        $doc->addScript( "http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js" );
        $doc->addScript('/templates/' . $getTemplateName . '/js/games32.js', 'text/javascript');
        // Display the view
        parent::display($tpl);
    }

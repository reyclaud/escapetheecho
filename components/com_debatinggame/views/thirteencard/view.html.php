...
class DebatingGameViewThirteencard extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        $doc->addStyleSheet('templates/' . $getTemplateName . '/css/games13.css');
        
        $doc->addScript( "http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js" );
        $doc->addScript('/templates/' . $getTemplateName . '/js/games13.js', 'text/javascript');        
        // Display the view
        parent::display($tpl);
    }

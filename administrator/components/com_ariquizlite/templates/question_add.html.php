...
<table class="adminform" style="width: 100%;">
	...
	<tbody id="tbQuestionSettings">
		...
		<tr valign="top">
			...
			<td align="left">
			<?php
				echo AriEditor::display('zQuiz[Question]', $question->QuestionVersion->Question, '100%;', '250', '40', '20');
...
<script type="text/javascript">
	aris.validators.validatorManager.addValidator(
		new aris.validators.customValidator('zQuizQuestion',
			function(val)
			{
				var isValid = true;
				var value = <?php echo AriEditor::getContent('zQuiz_Question') ; ?>;

<?php
// namespace administrator\components\com_instantfblogin\framework\google;
/**
...
require_once JPATH_ROOT . '/administrator/components/com_instantfblogin/framework/OAuth/bootstrap.php';
 ...
 * @since 2.0
 */
interface InstantfbloginSocialLoginInterface {
 ...
 * @since 2.0
 */
class InstantfbloginGoogleLogin implements InstantfbloginSocialLoginInterface {
	...
	public function loginCallback($accessCode) {
		...
		$googleUser = new InstantfbloginGoogleUser ( $userData );
		return $googleUser;
	}
}

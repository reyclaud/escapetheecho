<?php
// namespace administrator\components\com_instantfblogin\framework\controller;
/**
 ...
 * @since 1.6
 */
class InstantfbloginController extends JControllerLegacy {
	/**
	...
	public function editEntity() {
		...
		if (! $record = $model->loadEntity ( $idEntity )) {
			...
			$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_('COM_INSTANTFBLOGIN_ERROR_EDITING') );
			return false;
		}
		...
		if ($record->checked_out && $record->checked_out != $this->user->id) {
			$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_CHECKEDOUT_RECORD' ), 'notice' );
			return false;
		}
		
		// Access check
		if ($record->id && ! $this->allowEdit ( $this->option )) {
			$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_ERROR_ALERT_NOACCESS' ), 'notice' );
			return false;
		}
	...
	public function saveEntity() {
		...
		if (! $result = $model->storeEntity ()) {
			...
			$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".editEntity&cid[]=" . $this->app->input->get ( 'id' ), JText::_ ( 'COM_INSTANTFBLOGIN_ERROR_SAVING' ) );
			return false;
		}
		...
		$msg = 'COM_INSTANTFBLOGIN_SUCCESS' . $redirects ['msgsufix'];
	...
	public function cancelEntity() {
		...
		$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_CANCELED_OPERATION' ) );
	}
	...
	public function copyEntity() {
		...
		if (! $model->copyEntity ( $cids )) {
			...
			$modelException = $model->getError ( null, false );
			$this->app->enqueueMessage ( $modelException->getMessage (), $modelException->getErrorLevel () );
			$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_ERROR_DUPLICATING' ) );
			return false;
		}
		
		$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_SUCCESS_DUPLICATING' ) );
	}
	...
	public function deleteEntity() {
		...
		if (! $model->deleteEntity ( $cids )) {
			...
			$modelException = $model->getError ( null, false );
			$this->app->enqueueMessage ( $modelException->getMessage (), $modelException->getErrorLevel () );
			$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_ERROR_DELETE' ) );
			return false;
		}
		
		$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_SUCCESS_DELETE' ) );
	}
	...
	public function moveOrder() {
		...
		if (! $model->changeOrder ( $idEntity, $direction )) {
			...
			$modelException = $model->getError ( null, false );
			$this->app->enqueueMessage ( $modelException->getMessage (), $modelException->getErrorLevel () );
			$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_ERROR_REORDER' ) );
			return false;
		}
		
		$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_SUCCESS_REORDER' ) );
	}
	...
	public function publishEntities() {
		...
		if (! $model->publishEntities ( $idEntity, $this->task )) {
			...
			$modelException = $model->getError ( null, false );
			$this->app->enqueueMessage ( $modelException->getMessage (), $modelException->getErrorLevel () );
			$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_ERROR_STATE_CHANGE' ) );
			return false;
		}
		
		$this->setRedirect ( "index.php?option=" . $this->option . "&task=" . $this->corename . ".display", JText::_ ( 'COM_INSTANTFBLOGIN_SUCCESS_STATE_CHANGE' ) );
	}

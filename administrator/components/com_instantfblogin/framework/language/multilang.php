<?php
// namespace administrator\components\com_instantfblogin\framework\language;
/**
 ...
 * @since 1.6
 */
class InstantfbloginLanguageMultilang extends JLanguage {
	/**
	...
	public static function getInstance($lang = null, $debug = false) {
		...
		$langInstance = new InstantfbloginLanguageMultilang($locale);

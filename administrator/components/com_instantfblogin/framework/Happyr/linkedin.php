 ...
 */
class InstantfbloginHappyrLinkedin
{
    /**
     * The Application ID.
     *
    ...
    {
        return !empty($GLOBALS['_' . strtoupper('get')]['error']);
    }
    ...
    public function getError()
    {
        ...
        return new LoginError($GLOBALS['_' . strtoupper('get')]['error'], isset($GLOBALS['_' . strtoupper('get')]['error_description']) ? $GLOBALS['_' . strtoupper('get')]['error_description'] : null);
    }
